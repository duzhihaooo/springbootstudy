...
public class UserRoleController {
	...
	public UserRole getUR(@PathVariable int id){ return userRoleService.getUserRoleInfo(id); }
	...
	public void deleteUR(int id){ userRoleService.deleteUserRole(id); }
	...
	public UserRole addUR(UserRole userRole){ return userRoleService.addUserRole(userRole); }
	...
	public void updateUR(UserRole userRole){ userRoleService.updateUserRole(userRole); }
